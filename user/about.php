...
<div class="container">
    ...
    <div class="col-1"></div>
                ...
                <div class="bg-primary mb-3 p-2">
                    <h3 class="text-center text-white text-uppercase">ABOUT THE SYSTEM</h3>
                </div>
                ...
                <p class="text-justify">
                    With the CMS for Blog Website, bloggers can focus on what they do best: creating valuable content. Keep your blog organized, up-to-date, and appealing to your audience effortlessly.
                    <br>
                    <b>Simplify your blog management and share your passion with the world with our user-friendly CMS system!</b>
                </p>
                </div>
    <div class="col-1"></div>
    </div>
